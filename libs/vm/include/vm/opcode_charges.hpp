...
static const ChargeAmount CHARGE_LOCAL_VARIABLE_DECLARE_ASSIGN             = 9;
...
static const ChargeAmount CHARGE_DISCARD                                   = 3;
static const ChargeAmount CHARGE_DESTRUCT                                  = 4;
...
static const ChargeAmount CHARGE_JUMP                                      = 1;
static const ChargeAmount CHARGE_JUMP_IF_FALSE                             = 3;
static const ChargeAmount CHARGE_JUMP_IF_TRUE                              = DEFAULT_STATIC_CHARGE;
static const ChargeAmount CHARGE_RETURN                                    = 28;
static const ChargeAmount CHARGE_RETURN_VALUE                              = 28;
static const ChargeAmount CHARGE_FOR_RANGE_INIT                            = 6;
static const ChargeAmount CHARGE_FOR_RANGE_ITERATE                         = 6;
static const ChargeAmount CHARGE_FOR_RANGE_TERMINATE                       = 6;
static const ChargeAmount CHARGE_INVOKE_USER_DEFINED_FREE_FUNCTION         = 13;
static const ChargeAmount CHARGE_LOCAL_VARIABLE_PREFIX_INC                 = DEFAULT_STATIC_CHARGE;
static const ChargeAmount CHARGE_LOCAL_VARIABLE_PREFIX_DEC                 = DEFAULT_STATIC_CHARGE;
static const ChargeAmount CHARGE_LOCAL_VARIABLE_POSTFIX_INC                = DEFAULT_STATIC_CHARGE;
static const ChargeAmount CHARGE_LOCAL_VARIABLE_POSTFIX_DEC                = DEFAULT_STATIC_CHARGE;
static const ChargeAmount CHARGE_JUMP_IF_FALSE_OR_POP                      = 4;
static const ChargeAmount CHARGE_JUMP_IF_TRUE_OR_POP                       = 4;
static const ChargeAmount CHARGE_NOT                                       = 4;
static const ChargeAmount CHARGE_PRIMITIVE_EQUAL                           = 10;
...
static const ChargeAmount CHARGE_PRIMITIVE_LESS_THAN                       = 12;
static const ChargeAmount CHARGE_OBJECT_LESS_THAN                          = DEFAULT_OBJECT_CHARGE;
static const ChargeAmount CHARGE_PRIMITIVE_LESS_THAN_OR_EQUAL              = 12;
static const ChargeAmount CHARGE_OBJECT_LESS_THAN_OR_EQUAL                 = DEFAULT_OBJECT_CHARGE;
static const ChargeAmount CHARGE_PRIMITIVE_GREATER_THAN                    = 12;
static const ChargeAmount CHARGE_OBJECT_GREATER_THAN                       = DEFAULT_OBJECT_CHARGE;
static const ChargeAmount CHARGE_PRIMITIVE_GREATER_THAN_OR_EQUAL           = 12;
...
static const ChargeAmount CHARGE_PRIMITIVE_ADD                             = 10;
...
static const ChargeAmount CHARGE_PRIMITIVE_SUBTRACT                        = 10;
...
static const ChargeAmount CHARGE_LOCAL_VARIABLE_PRIMITIVE_INPLACE_MULTIPLY = 12;
...
static const ChargeAmount CHARGE_PRIMITIVE_DIVIDE                           = 36;
...
static const ChargeAmount CHARGE_LOCAL_VARIABLE_PRIMITIVE_INPLACE_DIVIDE    = 37;
